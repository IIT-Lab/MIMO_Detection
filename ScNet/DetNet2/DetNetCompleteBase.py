...
print("Tx:", K, " Rx:", N, " L:", L, " LOG_LOSS:", LOG_LOSS, " ResNet:", ResNet)
...
for i in range(1, L):
    ...
    if LOG_LOSS == 1:
        ...
        LOSS.append(tf.reduce_mean(
            tf.reduce_mean(tf.square(X - S[-1]), 1) + Noise_rate * tf.reduce_mean(tf.square(X - X_LS), 1)))
